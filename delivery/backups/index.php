...
?>
<p class="MsoNormal">Наша компания осуществляет доставку строго в указанное место. Доставка может осуществляться как малотоннажным, так и большегрузным грузовым транспортом.</p>
 
<p class="MsoNormal">Способ доставки зависит от количества груза и маршрута перевозки. Поэтому в каждом отдельном случае стоимость доставки будет рассчитываться индивидуально.</p>
 
<p class="MsoNormal">Наиболее выгодным способом перевозки груза является заказ тягача с бортовым прицепом. Он способен вместить в себя около 40 куб. м. продукции, поэтому цена за один километр будет минимальна.</p>
 
<p class="MsoNormal">Если необходимо перевезти 10-12 тон, уместно будет заказать манипулятор. Цена доставки груза манипулятором рассчитывается по тарифу 50 рублей за километр.</p>
 
<p class="MsoNormal">Если доставка груза осуществляется машиной, не оснащенной крановой установкой, цена выгрузки колеблется около 4 тыс. рублей.</p>
 
<p class="MsoNormal"><b><font size="4">Расчет цен доставки по республике Мордовия по газосиликатным блокам</font></b></p>
<div class="table-responsive">
<table class="MsoNormalTable table delivery-table" border="0" cellspacing="0" cellpadding="0" width="596" style="width: 460.3pt;">
  <tbody> 
    ...
    <tr style="height: 15pt;"> <td width="596" nowrap="" colspan="6" valign="bottom" style="width: 447.3pt; padding: 0cm 5.4pt; height: 15pt;"> 
